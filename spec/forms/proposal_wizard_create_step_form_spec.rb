...
module Decidim::Proposals
  describe ProposalWizardCreateStepForm do
    ...
    let(:config_helper) { create(:awesome_config, organization: organization, var: :proposal_custom_field_foo, value: nil) }
    let(:private_config_helper) { create(:awesome_config, organization: organization, var: :proposal_private_custom_field_bar, value: nil) }
