  ...
  module DecidimAwesome
    ...
    class Engine < ::Rails::Engine
      ...
      config.to_prepare do
        ...
        if DecidimAwesome.enabled?(:menu, :mobile_menu, :content_block_main_menu)
          Decidim::ContentBlocks::GlobalMenuCell.include(Decidim::DecidimAwesome::GlobalMenuCellOverride) if DecidimAwesome.enabled?(:content_block_main_menu)
