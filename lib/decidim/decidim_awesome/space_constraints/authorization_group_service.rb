  ...
  module DecidimAwesome
    class AuthorizationGroupService
      ...
      def matches_component_constraint?(component, constraint)
        return false unless constraint["component_manifest"].to_s == component.manifest.name.to_s
      ...
      def matches_space_constraint?(space, constraint)
        return false unless constraint["participatory_space_manifest"].to_s == space.class.participatory_space_manifest.name.to_s
      ...
      def matches_space_fields?(constraint, space)
        ...
        slug_match = constraint["participatory_space_slug"].blank? || constraint["participatory_space_slug"].to_s == space.try(:slug).to_s
        manifest_match = constraint["participatory_space_manifest"].blank? || constraint["participatory_space_manifest"].to_s == space.class.participatory_space_manifest.name.to_s
